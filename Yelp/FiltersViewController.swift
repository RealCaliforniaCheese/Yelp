...
class FiltersViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, FilterCellDelegate {
    ...
    var categories: [[String:String]]!  // array of dictionaries Display Name : Code as two type of keys
    ...
    func tableView(tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return categories.count    // categories always populated: OK implicit optional
    }
...
//        if filterStates[indexPath.row] != nil {
//            cell.filterSwitch.on = filterStates[indexPath.row]!
//        } else {
